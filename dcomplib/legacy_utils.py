...
def load_and_merge_scans(scan_file_paths, paths_file="~/.dcomplib/paths.json", metadata_file="metadata.json"):
    ...
    try:
        from dcomplib.store import canonicalize_master_data
...
def save_scan_data(scan_file_paths, context, data_was_modified, paths_file="~/.dcomplib/paths.json", metadata_file="metadata.json"):
