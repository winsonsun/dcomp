...
def run_diff_mode(args):
    ...
    """
    from dcomplib.entities import EntityResolver
    from dcomplib import load_and_merge_scans, load_jobs_file
    from dcomplib.store import resolve_token_path
    from dcomplib.reports import generate_diff_report
    from dcomplib.legacy_utils import reconstruct_items_map
