...
import re
import sys
from dcomp.combinators import Pipeline, Load, Filter, Rule, UnrollTree
...
def run_list_verb(args):
    ...
    from dcomp import load_jobs_file
...
def run_manage_verb(args):
    ...
    from dcomp import load_jobs_file, save_jobs_config
...
def resolve_for_diff(resolver, args_parts):
    ...
    from dcomp.combinators import UnrollTree, Pipeline
    pipeline = Pipeline([
