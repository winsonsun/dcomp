...
def run_scan_mode(args):
    ...
    """
    from dcomp import load_jobs_file, load_and_merge_scans, save_scan_data, save_jobs_config, ensure_path_mappings, get_or_create_path_token
    from dcomp.combinators import Pipeline, FS_Scan, Map, BuildTree, Rule, Filter
    from dcomp.io import IMAGE_EXTENSIONS, VIDEO_EXTENSIONS
    import dcomp.policy as policy
