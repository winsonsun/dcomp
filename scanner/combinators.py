...
class Log:
    ...
    def __init__(self, msg="Log:", level="INFO", rule=None):
        self.msg = msg
        self.level = level
        self.rule = rule or Rule(lambda x: x)
...
class Group:
    ...
    def __init__(self, by: Rule, collect: Rule = None):
        self.by = by
...
class Join:
    ...
    def __init__(self, stream_b_provider, on_key: Rule):
        self.stream_b_provider = stream_b_provider
        self.on_key = on_key
...
class Partition:
    ...
    def __init__(self, routes: dict):
        self.routes = routes # dict of name -> Rule
...
class CacheHit:
    ...
    def __init__(self, cache_provider, match_rule: Rule):
...
class BuildTree:
    ...
    def __init__(self, key_selector: Rule):
